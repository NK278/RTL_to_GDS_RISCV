...
set_attr library CORE65LPSVT_wc_1.10V_125C.lib
...
write_scandef> dft_report/rtl_module_min_area_dft_CORE65LPSVT_wc_1.10V_125C.def
write_sdf -timescale ns -nonegchecks -recrem split -edges check_edge > dft_report/delays_optimal_min_area_dft.sdf
write_hdl -mapped > dft_report/dft_syn_min_area_dft_CORE65LPSVT_wc_1.10V_125C.v
